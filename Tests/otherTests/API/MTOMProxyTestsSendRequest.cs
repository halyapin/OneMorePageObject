...
{
    class MTOMProxySendRequestTest : TestBase
    {
        [Test, Category("API")]
        public void TestSendRequestXmlProxyMtom()
        {
            ...
            var responseFromGate = app.Gate.SendRequestPostUnique("POST", contentType, headers, $"/smev/send/{recidEndpoints}", "Files\\sendrequest-mtom.xml");
